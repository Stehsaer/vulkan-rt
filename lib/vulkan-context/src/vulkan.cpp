...
#pragma region Features
	...
	vkutil::LinkedStruct<vk::PhysicalDeviceFeatures2> Features::get_device_features_chain() const noexcept
	{
		auto linked_struct =
			vkutil::LinkedStruct<vk::PhysicalDeviceFeatures2>({.features = required_vulkan10_features()});
